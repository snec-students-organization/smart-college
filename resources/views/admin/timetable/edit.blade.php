                    ...
                    <form action="{{ route('admin.timetable.update', $timetable->id) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="start_time" class="block mt-1 w-full" type="time" name="start_time" :value="old('start_time', \Carbon\Carbon::parse($timetable->start_time)->format('H:i'))" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="end_time" class="block mt-1 w-full" type="time" name="end_time" :value="old('end_time', \Carbon\Carbon::parse($timetable->end_time)->format('H:i'))" required />
